...
class LedgerReportController extends Controller
{
    public function index()
    {
        ...
        return view('reports.ledger.index', compact('products', 'suppliers'));
    }
    ...
    public function generateReport(Request $request)
    {
        ...
        $vendor = $supplierId ? Supplier::find($supplierId) : null;
        ...
        $stockMovements = PurchaseOrderItem::select(
            ...
            ->when($supplierId, function($query) use ($supplierId) {
                return $query->where('purchase_orders.supplier_id', $supplierId);
            })
